...
import com.example.demo.DateTest.DateUtils;

import java.util.Date;

import static com.example.demo.DateTest.DateUtils.*;

public class testDate {
    public static void main(String[] args) {

        //String strDate = "2013-01-01 11:23:23";
        ...
        new Date().setTime(Long.getLong("1527758779090"));
        //Date date=DateUtils.parseDate(new Date().toString(),"YYYY-MM-dd HH:mm:ss");
...
//        System.out.println(formatDate(getFirstAndLastDateOfMonth(date)[0],"YYYY-MM-dd HH:mm:ss")+"/n"+
//                formatDate(getFirstAndLastDateOfMonth(date)[1],"YYYY-MM-dd HH:mm:ss"));
    }
}
